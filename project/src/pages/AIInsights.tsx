...
export function AIInsights() {
  ...
  const getTypeIcon = (type: string) => {
    switch (type) {
      case 'turnover_prediction': return Users;
      case 'performance_anomaly': return TrendingUp;
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Predicciones y recomendaciones inteligentes para optimizar tu gestión de talento
          </p>
        </div>
                        ...
                        <div className="flex items-center space-x-3">
                          <Badge variant={getSeverityColor(insight.severity) as any}>
                            ...
                            {insight.severity === 'high' ? 'Crítico' : 
                             insight.severity === 'medium' ? 'Moderado' : 'Bajo'}
                          </Badge>
                    ...
                    {insight.affectedEmployees && insight.affectedEmployees.length > 0 && (
                      <div className="mb-4">
                        ...
                        <div className="flex items-center space-x-2">
                          {insight.affectedEmployees.slice(0, 3).map((employeeId) => {
                            const employee = employees.find(e => e.id === employeeId);
                            return employee ? (
                              <div key={employeeId} className="flex items-center space-x-2">
                                <img
                                  src={employee.avatar || 'https://images.pexels.com/photos/1043471/pexels-photo-1043471.jpeg?auto=compress&cs=tinysrgb&w=32&h=32&fit=crop'}
                                  alt={employee.name}
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-purple-800 mb-3">
                Nuestro sistema utiliza algoritmos de machine learning para analizar patrones en tu organización 
                y predecir tendencias futuras. Los modelos se entrenan continuamente con datos anonimizados 
                de miles de empresas ecuatorianas.
              </p>
